...
class _CustomModalWidgetState extends State<CustomModalWidget> {
  ...
  late final TextEditingController _formFieldControllerTwo;
  ...
  void initState() {
    ...
    _formFieldControllerTwo = TextEditingController();
            ...
            Material(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: TextFormField(
                      controller: _formFieldControllerTwo,
                  ...
                  onPressed: () {
                    if (form.currentState!.validate()) {
                      WeekModel weekModel = WeekModel(
                        ...
                        week: 'Semana ' +_formFieldControllerTwo.text,
